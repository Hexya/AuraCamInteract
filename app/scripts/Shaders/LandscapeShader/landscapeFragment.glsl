...
void main() {
    ...
    //BEST PURPLE
    vec3 color1 = vec3(9., 12., 70./2.) / 255.;
    vec3 color2 = vec3(25./4., 33., 150./2.) / 255.;
    ...
    vec3 color7 = vec3(25., 100., 255.) / 255.;

    vec3 color8 = mix(color5,color7,snoise(vPosition * .1 + uTime/10.));//TAILLE VITESSE PINK

    vec3 color = mix(color3,color8,snoise(vPosition * 100. + uTime));//NOISE
